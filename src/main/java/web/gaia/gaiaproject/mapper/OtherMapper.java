...
public interface OtherMapper {
    ...
    @Delete("delete from power where gameid = #{gameid} and giverace = #{giverace} and receiverace = #{receiverace} and structure = #{structure} and location = #{location}")
    public void deletePowerById(String gameid,String giverace,String receiverace,String location,String structure);
